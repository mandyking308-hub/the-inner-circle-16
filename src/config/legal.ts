 ...
 * selling and privacy law, plus the Dodo Payments merchant-of-record
 * position), then local addenda as member geographies expand.
 */
...
/** Documents a member accepts at checkout and at every sign-in. */
