    ...
    <header className="sticky top-0 z-50 border-b border-foreground/8 bg-[#f6f1e8]/95 backdrop-blur-xl">
      <Container className="flex h-[78px] items-center justify-between">
        <Link to="/" className="group flex items-center gap-3" aria-label={`${site.name} home`}>
          <BrandMark compact />
          <span className="font-display text-[1.28rem] leading-none tracking-[0.11em] text-foreground">MONTVELLE</span>
        </Link>
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="right" className="w-[90vw] max-w-sm border-l border-foreground/10 bg-[#f6f1e8] p-0">
            <div className="px-7 pb-5 pt-8">
              <div className="flex items-center gap-3"><BrandMark compact /><SheetTitle className="font-display text-xl tracking-[0.11em]">MONTVELLE</SheetTitle></div>
            </div>
