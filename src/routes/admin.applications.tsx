...
function ApplicationsPage() {
  ...
  const updateReview = (id: string, updater: (current: ApplicationReview) => ApplicationReview) => setReviews((current) => ({ ...current, [id]: updater(current[id] ?? { scores: {}, notes: "", referenceStatus: "Not started", conversationOwner: "Membership team" }) }));
