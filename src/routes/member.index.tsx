      ...
      <div className="grid gap-5 xl:grid-cols-[1.35fr_0.65fr]">
        <section className="border border-border bg-card">
          ...
          <div className="p-5 md:p-6">
            ...
            <Link to="/member/table" className="mt-5 inline-flex items-center gap-2 text-sm font-medium text-foreground underline decoration-bronze/40 underline-offset-4">
