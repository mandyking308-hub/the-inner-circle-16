...
function CommunityHubPage() {
  const rooms = [
    ...
    [Users, "Member Community", "People in Montvelle, the experience they hold, and why they might be relevant to what you are working on.", "/member/community"],
    [Network, "Introductions", "Ask for a warm introduction with context, a desired outcome and consent on both sides.", "/member/introductions"],
    [MessageSquareText, "Ask & Offer", "Put a real need or a useful offer in front of the community, without cold outreach.", "/member/ask-offer"],
  ] as const;
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="border border-border bg-foreground p-6 text-background md:p-8">
        ...
        <h2 className="mt-4 max-w-4xl font-display text-4xl leading-tight md:text-5xl">Consent first. No member list ever moves sideways.</h2>
        <p className="mt-5 max-w-3xl text-sm leading-7 text-background/65">
          Profiles exist so members can understand who is in the community. Contact details stay private by default, and introductions move
          through consent and context rather than extraction. If the expertise you need sits outside the community, ask us and we will source it.
        </p>
        <Link to="/member/services" className="mt-6 inline-flex items-center gap-2 text-sm font-semibold">
