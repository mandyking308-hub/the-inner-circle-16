...
function TheTablePage() {
  return <LuxuryStoryPage
    ...
    secondary={{ eyebrow: "Beyond the Table", title: "One good room should open into a much bigger world.", body: "Gatherings, warm introductions, global life, family experiences and private service sit around the Table so the relationships can become useful in ordinary life as well as memorable in the room.", image: luxuryImages.world, imageAlt: "A beautiful international destination", linkTo: "/global-life", linkLabel: "The World" }}
