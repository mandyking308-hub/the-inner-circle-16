...
type MemberRequest = {
  ...
  deadline: string;
  category: string;
  status: "New" | "Clarifying" | "Sourcing" | "Executing" | "Complete";
  owner: string;
  nextStep: string;
  createdAt: string;
...
const starterRequests: MemberRequest[] = [
  {
    ...
    status: "Sourcing",
    owner: "Sofia",
    nextStep: "Review the checked options and decide whether you want Montvelle to arrange an introduction.",
