    ...
    <section className="min-h-[70vh] bg-[#171716] py-24 text-white md:py-32">
      <Container>
        <div className="mx-auto max-w-3xl border border-white/15 p-8 md:p-12">
          <CheckCircle2 className="h-7 w-7 text-[#d8b36c]" />
          ...
          <Button asChild size="lg" className="mt-9 rounded-full bg-[#d8b36c] px-7 text-[#15130f] hover:bg-[#e4c47f]"><Link to="/">Return to Montvelle <ArrowRight className="ml-2 h-4 w-4" /></Link></Button>
        </div>
      </Container>
    </section>
  );
