...
function AdminConciergePage() {
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-3"><StatCard label="Open requests" value={String(conciergeRequests.length)} /><StatCard label="Awaiting member" value="1" note="Consent or clarification" /><StatCard label="Awaiting external response" value="2" note="Options or response" /></div>
