...
function FamilyHubPage() {
  const rooms = [
    [Landmark, "Family Architecture", "See ownership, protection, purpose, advisers and the family roles around them in one picture.", "/member/family-architecture"],
    [Globe2, "Global Life", "Coordinate residence, advisers, schools, property, banking and the dependencies created by a cross-border move.", "/member/global-life"],
    [GraduationCap, "Learning Studio", "Build a personalised curriculum around mastery, execution, practical independence and evidence.", "/member/learning"],
    [Sparkles, "Next Generation", "A protected programme for stewardship, enterprise, technology, financial literacy and philanthropy.", "/member/next-gen"],
    [BriefcaseBusiness, "The Continuum", "Move older learners into mentors, projects, apprenticeships, work and eventually giving back.", "/member/alumni"],
  ] as const;
