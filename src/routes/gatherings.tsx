...
function GatheringsPage() {
  return <LuxuryStoryPage
    ...
    feature={{ eyebrow: "Private programme", title: "Different rooms for different moments in life.", body: "Private dinners, breakfasts, salons, family programmes, retreats, cultural moments and impact visits each create a different kind of connection. Fewer events, better reasons to attend.", image: luxuryImages.culture, imageAlt: "A cultural experience in an international city", linkTo: "/the-table", linkLabel: "The permanent Table" }}
