    ...
    <>
      <EditorialDetailPage
        ...
        blocks={[
          ...
          { kicker: "Opportunity", title: "Turn relationships into real experience.", body: "Members and partner organisations we have worked with can create age-appropriate projects, placements, apprenticeships and early-career opportunities with enough context to make the experience meaningful on both sides." },
