...
function ControlRoomPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between"><div><p className="eyebrow text-bronze">Execution board</p><h2 className="mt-2 font-display text-3xl">Four lanes. No hiding behind research.</h2></div><div className="flex flex-wrap gap-2"><Button asChild variant="outline" className="rounded-none"><Link to="/member/table"><TableProperties className="mr-2 h-4 w-4" />Ask the Table</Link></Button><Button asChild variant="outline" className="rounded-none"><Link to="/member/partners"><BadgeCheck className="mr-2 h-4 w-4" />Find specialist</Link></Button><Button asChild className="rounded-none"><Link to="/member/concierge"><Compass className="mr-2 h-4 w-4" />Give Concierge the brief</Link></Button></div></div>
