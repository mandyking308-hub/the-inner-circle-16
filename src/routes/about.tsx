      ...
      <section className="bg-[#efe8dd] py-32 md:py-48">
        <Container>
          <div className="grid gap-16 lg:grid-cols-[1.18fr_0.82fr] lg:items-center lg:gap-24">
            <figure className="overflow-hidden"><img src={luxuryImages.gathering} alt="A private gathering among trusted people" className="aspect-[16/11] w-full object-cover" loading="lazy" /></figure>
            <div>
