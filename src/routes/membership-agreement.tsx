    ...
    <LegalTemplate
      ...
      sections={[
        ...
        },
        {
          ...
          body: "GSM operates and performs the Montvelle membership and services described in this Agreement. Where configured, Dodo Payments acts as the payment and transaction merchant of record for checkout, payment processing, applicable transaction taxes and refund processing, and its checkout page, receipt and statement descriptor may identify it as the seller of record for the payment transaction, with its own payment terms applying to that transaction. Where that arrangement applies it does not change GSM's obligations to the Member for supplying the membership, and it does not reduce any mandatory consumer right.",
        },
        {
