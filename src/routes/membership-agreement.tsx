  ...
  return (
    <LegalTemplate
      ...
      sections={[
        ...
        {
          heading: "2. Personal and family use",
          body: "Membership is personal to the approved Member and the authorised users identified or permitted in the Membership Schedule. It may not be sold, transferred, sublicensed, shared or used to provide access to an unauthorised person without GSM's prior written consent. The Member is responsible for ensuring that authorised users comply with this Agreement and all applicable Montvelle policies.",
        },
        {
        ...
        },
        {
          ...
          body: `The current ${membershipPricing.pricingYear} standard founding price is ${membershipPricing.annualDisplay} for a 12-month membership, paid in advance, plus a one-time ${membershipPricing.joiningDisplay} admission and onboarding fee. The first-year total is ${membershipPricing.firstYearDisplay} before applicable taxes and separately purchased third-party goods or services. The contractual amount for a Member is the amount shown at checkout, on the invoice or in the Membership Schedule. GSM may change prices for future new memberships and renewals. Taxes, duties, levies, payment charges, bank charges and similar amounts are payable as stated and as required by law. Where GSM agrees a different billing currency, the fixed contractual amount is stated in the applicable checkout, invoice or Membership Schedule.`,
        },
        {
