    ...
    <LegalTemplate
      ...
      sections={[
        ...
        },
        {
          ...
          body: "Nothing in this Agreement removes a cancellation, refund or consumer right that cannot lawfully be waived. Where a statutory cooling-off right applies and the Member does not separately and expressly request that onboarding, service preparation or services begin during that period, GSM will not begin the relevant consumer service until the cooling-off period has expired. Acceptance of this Agreement, the Membership Schedule or any other contractual document is not an early-start request, and neither is payment; an early-start request is a separate express request and is never assumed. Where the Member does expressly ask GSM to begin before that period expires and then cancels within it, GSM may deduct the value of services properly supplied before cancellation to the extent applicable law permits. Outside mandatory rights, refunds and the treatment of admission/onboarding work are governed by this Agreement, the Membership Schedule, the reason for termination and services already supplied. Third-party bookings and supplier charges are subject to the relevant supplier's own cancellation and refund rules and may be non-refundable.",
