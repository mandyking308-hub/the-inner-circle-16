...
import { ArrowRight, BookOpen, CalendarDays, HandHeart } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-px bg-border md:grid-cols-3">
        {[
          ...
          [BookOpen, "Knowledge", "Decision briefings, guides, playbooks and expert council material built around problems members actually face.", "/member/knowledge"],
