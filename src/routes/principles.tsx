...
function PrinciplesPage() {
  return <LegalTemplate title="Membership Principles" intro="The quality of a private community is not created by the room, the app or the membership fee. It is created by what members can expect from one another. These principles are the cultural constitution of Montvelle." sections={[
