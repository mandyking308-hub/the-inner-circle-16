...
export const Route = createFileRoute("/journal/")({
  head: () => ({
    ...
    links: [{ rel: "canonical", href: `${site.url}/journal` }],
  }),
      ...
      <section className="border-b border-foreground/15 py-14 md:py-20">
        <Container>
          <Link to="/journal/$slug" params={{ slug: lead.slug }} className="group grid overflow-hidden border border-foreground/15 bg-card lg:grid-cols-[1.12fr_0.88fr]">
            <div className="relative min-h-[420px] overflow-hidden"><img src={pageImages[lead.image]} alt="A globally mobile family arriving in London" className="absolute inset-0 h-full w-full object-cover transition-transform duration-700 group-hover:scale-[1.02]" /><div className="absolute inset-0 bg-gradient-to-t from-foreground/55 via-transparent to-transparent" /></div>
