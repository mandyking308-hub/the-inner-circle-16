    ...
    <LegalTemplate
      ...
      sections={[
        ...
        },
        {
          ...
          body: "Each party remains responsible for its own acts and omissions. The Supplier indemnifies GSM against losses, claims and reasonable costs arising from the Supplier's breach of these terms, breach of confidentiality or data protection obligations, infringement of third-party rights, or negligent or unlawful conduct. Nothing in these terms excludes or limits liability that cannot lawfully be excluded or limited, including for death or personal injury caused by negligence, or for fraud. Subject to that, neither party is liable for indirect or consequential loss.",
        },
        {
          heading: "21. Suspension and termination",
          body: "Montvelle may suspend portal access or terminate an assignment or the relationship immediately where there is a material breach, a confidentiality or data incident, loss of a required licence or insurance, a safeguarding or financial-crime concern, a sanctions issue, an undisclosed conflict, or conduct inconsistent with member trust. Either party may end the relationship on reasonable notice, subject to the orderly completion or handover of live matters.",
        },
        {
          heading: "22. Effect of termination and survival",
          body: "On termination the Supplier must stop using member information, return or securely delete it except where retention is required by law or professional rules, complete any agreed handover, and confirm compliance on request. Confidentiality, data protection, security, non-solicitation of members, records, indemnity, liability, intellectual property and governing law provisions survive termination.",
        },
        {
