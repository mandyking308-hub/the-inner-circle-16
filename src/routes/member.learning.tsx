...
function LearningStudioPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        <div className="flex items-end justify-between gap-5"><div><p className="eyebrow text-oxblood">Capability map</p><h2 className="mt-2 font-display text-3xl">Progress is not a school grade.</h2><p className="mt-3 max-w-2xl text-xs leading-6 text-muted-foreground">Score current independence from 1 = needs close support to 5 = can plan, deliver and review independently in age-appropriate contexts.</p></div></div>
