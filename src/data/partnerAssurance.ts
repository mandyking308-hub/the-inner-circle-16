...
export const partnerAssurance: PartnerAssurance[] = [
  {
    ...
    regulatoryNote:
      "Illustrative private-client legal provider. Members confirm the individual professional and jurisdiction appropriate to their matter before instruction.",
  ...
  },
  {
    ...
    regulatoryNote:
      "Residence-planning coordination; formal immigration and tax advice routed to appropriately authorised professionals in the relevant jurisdiction.",
    conflicts:
      "Provider relationships disclosed where a recommended route generates third-party fees.",
  ...
  },
  {
    ...
    regulatoryNote:
      "Education advisory service. School admissions decisions remain with the relevant school and family.",
    conflicts:
      "Any school referral relationship must be disclosed before a recommendation is treated as independent.",
    referralDisclosure:
      "Member benefit recorded separately from any school-side commercial arrangement.",
  ...
  },
  {
    ...
    regulatoryNote:
      "Cyber and privacy services; scope and data-handling terms confirmed before access to member systems.",
  ...
  },
  {
    ...
    regulatoryNote:
      "Recruitment and staffing provider; reference, right-to-work and role-specific screening processes vary by placement and jurisdiction.",
  ...
  },
  {
    ...
    regulatoryNote:
      "Navigation and coordination only; clinical advice and treatment remain with appropriately qualified healthcare professionals.",
...
export const getPartnerAssurance = (partnerId: string) =>
  partnerAssurance.find((item) => item.partnerId === partnerId);
