...
export const accessOrganisations: AccessOrganisation[] = [
  ...
  { id: "iac", audience: "personal", name: "International Associate Clubs (IAC)", category: "clubs", geography: "Global", publicDisplay: true, relationshipStatus: "sourced", sourceSystem: "liftor", sourceRecordId: "montvelleSupplierSeed:iac" },
  { id: "lhw", audience: "personal", name: "The Leading Hotels of the World", category: "travel", geography: "Global", publicDisplay: true, relationshipStatus: "sourced", sourceSystem: "liftor", sourceRecordId: "montvelleSupplierSeed:leading-hotels" },
  { id: "preferred", audience: "personal", name: "Preferred Hotels & Resorts", category: "travel", geography: "Global", publicDisplay: true, relationshipStatus: "sourced", sourceSystem: "liftor", sourceRecordId: "montvelleSupplierSeed:preferred-hotels" },
  ...
  { id: "rosewood", audience: "personal", name: "Rosewood Hotel Group", category: "travel", geography: "Global", publicDisplay: true, relationshipStatus: "sourced", sourceSystem: "liftor", sourceRecordId: "montvelleSupplierSeed:rosewood" },
  ...
  { id: "ubs-gwm", audience: "business", name: "UBS Global Wealth Management", category: "banking", geography: "Global", publicDisplay: true, relationshipStatus: "sourced", sourceSystem: "liftor", sourceRecordId: "montvelleAdvisoryNetwork:ubs" },
  { id: "jpm-private-bank", audience: "business", name: "J.P. Morgan Private Bank", category: "banking", geography: "Global", publicDisplay: true, relationshipStatus: "sourced", sourceSystem: "liftor", sourceRecordId: "montvelleAdvisoryNetwork:jpm-private-bank" },
  ...
  { id: "henley-partners", audience: "business", name: "Henley & Partners", category: "legal", geography: "Global", publicDisplay: true, relationshipStatus: "sourced", sourceSystem: "liftor", sourceRecordId: "montvelleAdvisoryNetwork:henley-partners" },
];
