...
export const journalArticles: JournalArticle[] = [
  {
    ...
    date: "August 2026",
    image: "jet",
    introduction: "Success rarely arrives as one neat event. It accumulates. A business grows. Opportunities move across borders. A family needs more privacy, more advisers and more deliberate decisions. The strange part is that each problem usually has an expert, while nobody is responsible for the whole picture.",
    sections: [
      {
