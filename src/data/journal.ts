...
export const journalArticles: JournalArticle[] = [
  {
    ...
    sections: [
      ...
      { heading: "The principal still owns the decision", body: "Good specialists should make a family safer, not more passive. The principal needs enough context to understand the trade-offs, know which professional owns which question and recognise when two pieces of advice do not fit together." },
      { heading: "Time becomes the scarce asset", body: "At a certain point the premium service is not more information. It is fewer repeated explanations, fewer cold searches, fewer dropped hand-offs and fewer decisions sitting unresolved because nobody has been given the job of closing them." },
    ],
  },
  {
    ...
    sections: [
      ...
      { heading: "Sequence matters", body: "Housing may depend on banking. Banking may depend on residence documents. Schools may need an address. Tax advice may change the timing of a company decision. A move room should identify those dependencies before deposits are paid and deadlines are missed." },
      { heading: "Advice still needs reconciliation", body: "Immigration counsel can be correct about immigration while tax counsel is correct about tax and the combined plan still does not work. Someone must hold the shared timeline and push contradictory assumptions back into the room until they are resolved." },
    ],
  },
  {
    ...
    sections: [
      ...
      { heading: "Teach the loop", body: "Know the subject. Apply it in context. Deliver for someone else. Review what happened. That loop trains judgement, communication, resilience and the habit of finishing — capabilities that cannot be reduced to one mark on one test." },
      { heading: "Evidence changes the conversation", body: "Over time a learner can build a portfolio of projects, presentations, ventures, references, service, code, writing and feedback. The question becomes less ‘what grade did you get?’ and more ‘what can you now do independently?’" },
    ],
  },
  {
    ...
    sections: [
      ...
      { heading: "Build for absence", body: "A good test is to imagine the principal unavailable for ninety days. Which bills stop? Which renewals disappear? Which adviser has the only copy of a critical document? Which decisions cannot be made? The answers reveal where an operating system is needed." },
      { heading: "The dashboard should reduce questions", body: "The family should be able to see what it owns, what needs attention, who is responsible and which decisions remain open without asking five different people for five different spreadsheets." },
    ],
  },
  {
    ...
    sections: [
      ...
      { heading: "Let them build something of their own", body: "Enterprise is easier to understand after creating value for a real customer, managing a small budget, handling a mistake and finishing a project. Capability should not depend on the family already owning the answer." },
      { heading: "Stewardship includes service", body: "Philanthropy and contribution give the next generation somewhere to practise judgement that is not purely about private consumption. They also make the purpose of resources a family conversation rather than an inheritance surprise." },
    ],
  },
  {
    ...
    sections: [
      ...
      { heading: "Track unresolved contradictions", body: "Do not silently choose between conflicting advice. Record the contradiction, identify which advisers need to speak and assign someone to close it. An unresolved dependency is a task, not background noise." },
      { heading: "Keep a decision log", body: "Record the decision, the professional inputs relied on, the date, the owner and any follow-up control. It creates continuity when advisers change and makes future reviews far easier." },
    ],
  },
];

export const findJournalArticle = (slug: string) => journalArticles.find((article) => article.slug === slug);
